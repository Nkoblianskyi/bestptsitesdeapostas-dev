          ...
          <div>
            ...
            <div className="space-y-1.5">
              <p className="text-xs md:text-sm text-gray-700">
                MelhoresApostas.com é um serviço gratuito para ajudá-lo a encontrar plataformas de apostas. Recebemos
                taxas de marcas em destaque, afetando a sua colocação.
              </p>
              <p className="text-xs md:text-sm text-gray-700">
